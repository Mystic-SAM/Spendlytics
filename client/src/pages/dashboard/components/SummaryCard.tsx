...
import { DateRangeEnum, type DateRangeType } from "@/components/DateRangeSelect";

type CardType = "balance" | "income" | "expenses" | "investment" | "savings";
...
const getCardStatus = (
  ...
  if (value === 0) {
    ...
    return {
      label: `No ${typeLabelMap[cardType]}`,
      color: "text-gray-400",
      Icon: TrendingDownIcon,
      description: ``,
    };
...
const getTrendDirection = (value: number, cardType: CardType) => {
  ...
  // For income, balance, and investment, higher is better
  return value >= 0 ? "positive" : "negative";
};
...
const SummaryCard: FC<SummaryCardProps> = ({
  ...
  return (
    <Card className="!border-none !border-0 !gap-0 !bg-white/5 flex-1 basis-[calc(33.333%-1rem)] min-w-[280px]">
      <CardHeader className="flex flex-row items-center justify-center space-y-0 !pb-5">
